...
for mon_chip in range(8):
    mon_chipchn  = 5
    adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=0, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x1F, sgp=1, sps=sps, sdf=0)
    input("")
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=0, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=1)
#input("")
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=1, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=0)
#input("")
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=1, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=1)
#input("")
#mon_chipchn = 4
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=0, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=0)
#input("")
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=0, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=1)
#input("")
#adcrst = chk.wib_fe_mon(femb_ids=fembs, mon_type=0, snc=1, mon_chip=mon_chip, mon_chipchn=mon_chipchn, adac_pls_en=1, sts=1, swdac=1, dac=0x20, sgp=1, sps=sps, sdf=0)
